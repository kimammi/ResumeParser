...
def university_extractor(input_string, nlp):
    ...
    doc_universities = filter(lambda x: 'University' in x or 'College' in x, doc_universities)
...
patternb = [{"TEXT": {"REGEX": "[Mm]ajor(ed)?"}}, {"TEXT": {"REGEX": ": ?"}}, {"POS": "PROPN","OP":"*"}, 
            {"POS": "PROPN","OP":"*"}, {"POS": "PROPN"}]
patternc = [{"TEXT": {"REGEX": "([Bb]achelor('s)?|[Mm]aster('s)?)"}}, {"TEXT": {"REGEX": "(of|in)"}}, 
            {"TEXT": {"REGEX": "(Sciences?|Arts?)"}, "OP": "*"},
            {"TEXT": {"REGEX": "(of|in)"}, "OP": "*"}, {"POS": "PROPN", "OP":"*"},{"POS": "PROPN", "OP":"*"},{"POS": "PROPN", "OP":"*"}]
patternd = [{"TEXT": {"REGEX": "(B|M)\.?(S|A)\.?"}}, {"TEXT": {"REGEX": "(,|:|in|of|[Dd]egree)"}}, {"TEXT": {"REGEX": "(in|of)"}, "OP":"*"},
